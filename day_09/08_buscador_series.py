...
# Extraer zip que contiene instrucciones del ejercicio.
# shutil.unpack_archive('Proyecto+Dia+9.zip','Extraccion Terminada','zip')

ruta = '/Users/glenn/PycharmProjects/PythonProject/day_09/Extraccion Terminada/Mi_Gran_Directorio'
